...
public class Aadapter extends RecyclerView.Adapter<Aadapter.myViewHolder> {
    ...
    public Aadapter(Context c, ArrayList<Booking> b, onDetailsListener onDetailsListener) {
        context = c;
        bookings = b;
    ...
    public myViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.approvallayout,parent,false);
        return new myViewHolder(view,monDetailsListener);
    }
    ...
    class myViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        TextView bookingID, userID;
        Button statusbtn;
        RelativeLayout parentlayout;
        onDetailsListener onDetailsListener;

        public myViewHolder(View itemView, onDetailsListener onDetailsListener) {
            super(itemView);
        ...
        public void onClick(View v) {
            ...
            Intent intent = new Intent(v.getContext(), BookingListDetails.class);
